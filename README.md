...
| --- | --- | --- | --- |
| `inventory.json` | `res/` | Sekai Inventory | User's card collection (created/modified by app) |
| `cards.json` | `res/` | [Sekai-World](https://github.com/Sekai-World/sekai-master-db-en-diff/blob/main/cards.json) | Game card database (fetched from upstream) |
| `gameCharacters.json` | `res/` | [Sekai-World](https://github.com/Sekai-World/sekai-master-db-en-diff/blob/main/gameCharacters.json) | Character metadata (fetched from upstream) |
| `skills.json` | `res/` | [Sekai-World](https://github.com/Sekai-World/sekai-master-db-en-diff/blob/main/skills.json) | Skills data (fetched from upstream) |
| `metadata.json` | `res/` | Sekai Inventory | Fetch timestamps & Git commit ID (generated by app) |
