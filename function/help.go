...
var helpSections = []commandSection{
	...
	},
	{
		...
		commands: []commandHelp{
			{
				"search [--<field> <value>]",
				"List cards that are available but not in the inventory",
				[]fieldHelp{
	...
	},
	{
		...
		commands: []commandHelp{
			{
				"add <cardID> [...]",
				"Add one or more cards to the inventory with default values",
				nil,
			},
			{
				"remove <cardID> [...]",
				"Remove one or more cards from the inventory",
				nil,
			},
			{
